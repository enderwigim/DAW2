...
** Repositorio de la práctica
   El *repositorio base* de la práctica está disponible en: https://github.com/DWEC-24-25/dwec-24-25-classroom-66db84-pr-gestor-de-presupuesto-dwec-practica_dwec_gestor_presupuesto, que es privado.

   Al aceptar tu tarea de GitHub classroom, se te habrá creado un repositorio personal en la organización DWEC-24-25 de la forma https://github.com/DWEC-24-25/dwec-24-25-classroom-66db84-pr-gestor-de-presupuesto-dwec-practica_dwec_gestor_presupuesto-usuario, donde *usuario* es tu nombre de usuario en GitHub.
...
2. Hacer un /fork/ del repositorio base https://github.com/DWEC2324/practica_dwec_gestor_presupuesto.git en tu cuenta de GitHub
3. Abrir un terminal
